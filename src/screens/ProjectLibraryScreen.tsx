...
const styles = StyleSheet.create({
  ...
  releasePathBoard: {
    ...
    padding: 14,
    borderRadius: 18,
    backgroundColor: 'rgba(8,18,36,0.75)',
    borderWidth: 1,
    borderColor: C.borderSubtle,
    gap: 10,
  },
  ...
  releasePathTitle: {color: C.textTitle, fontSize: 17, fontWeight: '900', marginTop: 5},
  releasePathDetail: {color: C.textBody, fontSize: 13, lineHeight: 20},
  ...
  releasePathSignalLabel: {color: C.textMuted, fontSize: 12, fontWeight: '800'},
  releasePathSignalText: {color: C.textBody, fontSize: 13, lineHeight: 20},
  ...
  releasePathSignalMuted: {color: C.textMuted, fontSize: 11, lineHeight: 16},
