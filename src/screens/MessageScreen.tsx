...
const styles = StyleSheet.create({
  ...
  row: {
    ...
    paddingHorizontal: 20, paddingVertical: 14, backgroundColor: C.bgRoot,
  },
  avatar: {justifyContent: 'center', alignItems: 'center', borderWidth: 1.5, flexShrink: 0},
  avatarInitial: {fontWeight: '800'},
  rowContent: {flex: 1, marginLeft: 14, marginRight: 8},
  rowTop: {flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between'},
  agentName: {fontSize: 15, fontWeight: '800', flex: 1},
  timestamp: {fontSize: 12, color: C.textMuted, marginLeft: 8},
  agentRole: {fontSize: 11, color: C.textMuted, marginTop: 1},
  lastMessage: {fontSize: 13, color: C.textSecondary, marginTop: 4, lineHeight: 18},
  badge: {
