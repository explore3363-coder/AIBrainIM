...
const styles = StyleSheet.create({
  ...
  cardTitle: {flex: 1, color: C.textTitle, fontSize: 16, fontWeight: '800'},
  urgencyBadge: {
    paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999, borderWidth: 1,
  },
  urgencyText: {fontSize: 11, fontWeight: '800'},
  cardDesc:  {color: C.textBody, fontSize: 14, lineHeight: 20, marginTop: 8},
  cardMeta:  {color: C.textMuted, fontSize: 12, marginTop: 6},
  statusBadge: {
  ...
  resolutionNote: {color: C.textMuted, fontSize: 13, lineHeight: 20, marginTop: 8},
  followUpBox: {
    marginTop: 10,
    padding: 10,
    borderRadius: 14,
  ...
  followUpTitle: {color: C.textTitle, fontSize: 13, fontWeight: '800'},
  followUpMeta: {color: C.textMuted, fontSize: 12, lineHeight: 18},
  followUpLink: {color: C.primary, fontSize: 12, lineHeight: 18, fontWeight: '800'},
  ...
  deferBtnText: {color: C.primary, fontWeight: '700', fontSize: 15},
  reopenBtn: {
    flex: 1, paddingVertical: 10, borderRadius: 12,
    backgroundColor: 'rgba(148,163,184,0.12)',
    borderWidth: 1, borderColor: C.borderSubtle, alignItems: 'center',
  },
  reopenBtnText: {color: C.textBody, fontWeight: '800', fontSize: 15},
