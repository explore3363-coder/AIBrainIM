...
const styles = StyleSheet.create({
  ...
  monthlyLabel: {color: C.textMuted, fontSize: 11},
  monthlyValue: {color: C.primary, fontSize: 28, fontWeight: '900', marginTop: 4},
  ...
  equipInfo: {flex: 1},
  equipName: {color: C.textTitle, fontSize: 13, fontWeight: '800'},
  equipMeta: {color: C.textMuted, fontSize: 11, marginTop: 2},
  equipStatusBadge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 999,
  ...
  equipStatusText: {fontSize: 10, fontWeight: '900'},
  ...
  alertInfo: {flex: 1},
  alertTitle: {color: C.textTitle, fontSize: 13, fontWeight: '800'},
  alertMeta: {color: C.textMuted, fontSize: 11, marginTop: 2},
  alertLevelBadge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 999,
  ...
  alertLevelText: {fontSize: 10, fontWeight: '900'},
  ...
  safetyScore: {fontSize: 28, fontWeight: '900'},
  safetyLabel: {color: C.textMuted, fontSize: 11, marginTop: 4},
  safetyRateRow: {
    flexDirection: 'row',
  ...
  safetyRateLabel: {color: C.textMuted, fontSize: 12},
  safetyRateValue: {color: C.primary, fontSize: 14, fontWeight: '900'},
