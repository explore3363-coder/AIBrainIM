...
const styles = StyleSheet.create({
  ...
  overviewLabel: {color: C.textMuted, fontSize: 11, fontWeight: '700'},
  overviewValue: {color: C.textTitle, fontSize: 22, fontWeight: '900', marginTop: 4},
  summaryCard: {
    marginBottom: 12, padding: 14, borderRadius: 18,
    backgroundColor: 'rgba(8,18,36,0.62)',
    borderWidth: 1, borderColor: C.borderSubtle,
  },
  summaryEyebrow: {color: C.accent, fontSize: 12, fontWeight: '900', marginBottom: 8, letterSpacing: 1},
  ...
  stepTitle:  {color: C.textTitle, fontWeight: '900', fontSize: 16},
  stepActor:  {color: C.accent, fontWeight: '800', fontSize: 11, marginTop: 4},
  stepDetail: {color: C.textBody, fontSize: 14, lineHeight: 20, marginTop: 5},
  ...
  historyText: {flex: 1, color: C.textTitle, fontSize: 14, fontWeight: '800'},
  ...
  emptyDesc:   {color: C.textBody, fontSize: 15, lineHeight: 22, textAlign: 'center'},
  emptyPrimaryBtn: {
    marginTop: 8,
    paddingHorizontal: 20, paddingVertical: 11,
    borderRadius: 999, backgroundColor: C.primary,
  },
  emptyPrimaryBtnText: {color: C.bgRoot, fontWeight: '900', fontSize: 15},
  detailNavBtn: {
    marginTop: 8,
    paddingHorizontal: 20, paddingVertical: 11,
    borderRadius: 999,
