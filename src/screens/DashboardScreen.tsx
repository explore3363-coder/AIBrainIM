...
const twinStyles = StyleSheet.create({
  ...
  preview: { height: 200, backgroundColor: '#0a1628' },
  previewBg: {
    flex: 1,
  ...
  metaLeft: { flex: 1 },
  metaTitle: { color: C.textTitle, fontSize: 15, fontWeight: '800' },
...
const eqStyles = StyleSheet.create({
  ...
  dot: { width: 9, height: 9, borderRadius: 4.5, marginBottom: 5 },
  name: { color: C.textPrimary, fontSize: 12, fontWeight: '700', textAlign: 'center', marginBottom: 2 },
...
const alStyles = StyleSheet.create({
  ...
  indicator: { width: 4, height: 40, borderRadius: 2, flexShrink: 0 },
  content: { flex: 1 },
...
const wpStyles = StyleSheet.create({
  ...
  role: { color: C.textMuted, fontSize: 12, marginTop: 2 },
  zone: {
...
const phStyles = StyleSheet.create({
  ...
  label: { color: C.textMuted, fontSize: 12, marginTop: 3 },
});
...
const styles = StyleSheet.create({
  ...
  pageTitleText: { color: C.textPrimary, fontSize: 26, fontWeight: '900' },
});
